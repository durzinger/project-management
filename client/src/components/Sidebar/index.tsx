            ...
            <div className="z-10 mt-32 flex w-full flex-col items-center gap-4 bg-white px-8 py-4 dark:bg-black md:hidden">
                <div className="flex w-full items-center">
                    <div className="align-center flex h-9 w-9 justify-center">
                        ...
                        <Image 
                            src={`https://pm-s3-kuvat.s3.eu-north-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
    ...
    return (
        <Link href={href} className='w-full'>
            <div className={`relative flex cursor-pointer items-center gap-3 
                transition-colors hover:bg-gray-100 dark:bg-neutral-900 ${
                isActive ? "bg-gray-100 text-white dark:" : ""
